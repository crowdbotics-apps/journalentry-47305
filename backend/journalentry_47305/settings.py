"""
Django settings for journalentry_47305 project.
...
ROOT_URLCONF = 'journalentry_47305.urls'
...
WSGI_APPLICATION = 'journalentry_47305.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "journalentry_47305 API",
    "DESCRIPTION": "API documentation for journalentry_47305 App",
    "VERSION": "v1",
}
